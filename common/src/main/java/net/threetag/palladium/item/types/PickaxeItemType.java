...
public class PickaxeItemType implements ItemParser.ItemTypeSerializer {

    @Override
    public PickaxeItem parse(JsonObject json, Item.Properties properties) {
    ...
    public ResourceLocation getId() {
        return ResourceLocation.withDefaultNamespace("pickaxe");
    }
}
