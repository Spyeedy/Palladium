...
public class AxeItemType implements ItemParser.ItemTypeSerializer {

    @Override
    public AxeItem parse(JsonObject json, Item.Properties properties) {
    ...
    public ResourceLocation getId() {
        return ResourceLocation.withDefaultNamespace("axe");
    }
}
