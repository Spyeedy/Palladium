...
public class ShovelItemType implements ItemParser.ItemTypeSerializer {

    @Override
    public ShovelItem parse(JsonObject json, Item.Properties properties) {
    ...
    public ResourceLocation getId() {
        return ResourceLocation.withDefaultNamespace("shovel");
    }
}
