...
public class ParticleEmitterConfiguration {
    ...
    public static final Codec<ParticleEmitterConfiguration> CODEC = CodecExtras.listOrPrimitive(ParticleEmitter.CODEC).xmap(ParticleEmitterConfiguration::new, e -> e.emitters);
