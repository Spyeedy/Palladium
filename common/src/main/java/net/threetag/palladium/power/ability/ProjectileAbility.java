...
public class ProjectileAbility extends Ability {
    ...
    public static final MapCodec<ProjectileAbility> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(
                    ...
                    CodecUtils.NON_NEGATIVE_FLOAT.optionalFieldOf("inaccuracy", 0F).forGetter(ab -> ab.inaccuracy),
                    CodecUtils.NON_NEGATIVE_FLOAT.optionalFieldOf("velocity", 1.5F).forGetter(ab -> ab.velocity),
